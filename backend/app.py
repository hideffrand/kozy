...
#     "origins": ["http://localhost:5174","https://p9jctgvq-5174.asse.devtunnels.ms/"],
#     "methods": ["GET", "POST", "PUT"],
#     "allow_headers": ["Content-Type"]
# }})
CORS(app, origins=["http://localhost:5174",
     "https://p9jctgvq-5174.asse.devtunnels.ms"], methods=["GET", "POST", "PUT", "PATCH"])
# CORS(app)
...
def index():
    return send_response(http_ok, 'TOL')
